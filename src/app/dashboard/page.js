...
const App = () => {
    ...
    useEffect(() => {
        if (localStorage.getItem("baseCurrency")) {
            setBaseCurrency(localStorage.getItem("baseCurrency"));
        }
            ...
            <div className={styles.chartSelect}>
                <div className={styles.currencySelect}>
                    <FormControl fullWidth>
                        ...
                        <FormHelperText>
                            Convert 1 {baseCurrency} to other currencies
                        </FormHelperText>
                    </FormControl>

                    {dataReady && baseCurrency !== "" && <Conversion baseCurrency={baseCurrency} />}
                </div>
